...
export function SunIcon({ size = 48, className }) {
  return (
    <motion.svg viewBox="0 0 48 48" fill="none" className={className} style={{ width: size, height: size }}>
...
export function MoonIcon({ size = 48, className }) {
  const stars = [
    { cx: 34, cy: 10, d: 0 }, { cx: 38, cy: 18, d: 0.5 },
    { cx: 30, cy: 6, d: 1 }, { cx: 40, cy: 12, d: 1.5 },
  ];
  return (
    <svg viewBox="0 0 48 48" fill="none" className={className} style={{ width: size, height: size }}>
...
export function RainIcon({ size = 48, className }) {
  const drops = [
...
export function SnowIcon({ size = 48, className }) {
  const flakes = [
...
export function ThunderIcon({ size = 48, className }) {
  return (
    <svg viewBox="0 0 48 48" fill="none" className={className} style={{ width: size, height: size }}>
...
export function WindIcon({ size = 48, className }) {
  return (
    <svg viewBox="0 0 48 48" fill="none" className={className} style={{ width: size, height: size }}>
...
export function FogIcon({ size = 48, className }) {
  const lines = [
...
export function SunriseIcon({ size = 48, className }) {
  return (
    <svg viewBox="0 0 48 48" fill="none" className={className} style={{ width: size, height: size }}>
...
export function RainbowIcon({ size = 48, className }) {
  const arcs = [
...
// Maps OpenWeatherMap icon codes to animated icon components
const iconMap = {
  "01d": SunIcon,
  "01n": MoonIcon,
...
export function WeatherIcon({ code, size = 48, className }) {
  const Icon = iconMap[code] ?? CloudIcon;
